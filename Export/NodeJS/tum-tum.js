...
TumTum.main = function() {
	...
	var outputPath = "";
	var inputPath = "";
	var settings_defs = new haxe.ds.StringMap();
	var settings_compile = false;
...
gscript.Const.CInt = function(v) { var $x = ["CInt",0,v]; $x.__enum__ = gscript.Const; return $x; };
gscript.Const.CFloat = function(f) { var $x = ["CFloat",1,f]; $x.__enum__ = gscript.Const; return $x; };
gscript.Const.CString = function(s) { var $x = ["CString",2,s]; $x.__enum__ = gscript.Const; return $x; };
...
gscript.Expr.EConst = function(c) { var $x = ["EConst",0,c]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EIdent = function(v) { var $x = ["EIdent",1,v]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EVar = function(n,t,e) { var $x = ["EVar",2,n,t,e]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EParent = function(e) { var $x = ["EParent",3,e]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EBlock = function(e) { var $x = ["EBlock",4,e]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EField = function(e,f) { var $x = ["EField",5,e,f]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.ERefAccess = function(l,r) { var $x = ["ERefAccess",6,l,r]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EBinop = function(op,e1,e2) { var $x = ["EBinop",7,op,e1,e2]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EUnop = function(op,prefix,e) { var $x = ["EUnop",8,op,prefix,e]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.ECall = function(e,params) { var $x = ["ECall",9,e,params]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EIf = function(cond,e1,e2) { var $x = ["EIf",10,cond,e1,e2]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EWhile = function(cond,e) { var $x = ["EWhile",11,cond,e]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EFor = function(v,it,e) { var $x = ["EFor",12,v,it,e]; $x.__enum__ = gscript.Expr; return $x; };
...
gscript.Expr.EFunction = function(args,e,name,ret) { var $x = ["EFunction",15,args,e,name,ret]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EReturn = function(e) { var $x = ["EReturn",16,e]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EArray = function(e,index) { var $x = ["EArray",17,e,index]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EArrayDecl = function(e) { var $x = ["EArrayDecl",18,e]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.ENew = function(cl,params) { var $x = ["ENew",19,cl,params]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EDelete = function(id) { var $x = ["EDelete",20,id]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EThrow = function(e) { var $x = ["EThrow",21,e]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.ETry = function(e,v,t,ecatch) { var $x = ["ETry",22,e,v,t,ecatch]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.EObject = function(fl) { var $x = ["EObject",23,fl]; $x.__enum__ = gscript.Expr; return $x; };
gscript.Expr.ETernary = function(cond,e1,e2) { var $x = ["ETernary",24,cond,e1,e2]; $x.__enum__ = gscript.Expr; return $x; };
gscript.CType = $hxClasses["gscript.CType"] = { __ename__ : ["gscript","CType"], __constructs__ : ["CTPath","CTFun","CTAnon","CTParent"] };
gscript.CType.CTPath = function(path,params) { var $x = ["CTPath",0,path,params]; $x.__enum__ = gscript.CType; return $x; };
gscript.CType.CTFun = function(args,ret) { var $x = ["CTFun",1,args,ret]; $x.__enum__ = gscript.CType; return $x; };
gscript.CType.CTAnon = function(fields) { var $x = ["CTAnon",2,fields]; $x.__enum__ = gscript.CType; return $x; };
gscript.CType.CTParent = function(t) { var $x = ["CTParent",3,t]; $x.__enum__ = gscript.CType; return $x; };
...
gscript.Error.EInvalidChar = function(c) { var $x = ["EInvalidChar",0,c]; $x.__enum__ = gscript.Error; return $x; };
gscript.Error.EUnexpected = function(s) { var $x = ["EUnexpected",1,s]; $x.__enum__ = gscript.Error; return $x; };
...
gscript.Error.EUnknownVariable = function(v) { var $x = ["EUnknownVariable",4,v]; $x.__enum__ = gscript.Error; return $x; };
gscript.Error.EInvalidIterator = function(v) { var $x = ["EInvalidIterator",5,v]; $x.__enum__ = gscript.Error; return $x; };
gscript.Error.EInvalidOp = function(op) { var $x = ["EInvalidOp",6,op]; $x.__enum__ = gscript.Error; return $x; };
gscript.Error.EInvalidAccess = function(f) { var $x = ["EInvalidAccess",7,f]; $x.__enum__ = gscript.Error; return $x; };
...
gscript._Interp.Stop.SReturn = function(v) { var $x = ["SReturn",2,v]; $x.__enum__ = gscript._Interp.Stop; return $x; };
...
gscript.Token.TConst = function(c) { var $x = ["TConst",1,c]; $x.__enum__ = gscript.Token; return $x; };
gscript.Token.TId = function(s) { var $x = ["TId",2,s]; $x.__enum__ = gscript.Token; return $x; };
gscript.Token.TOp = function(s) { var $x = ["TOp",3,s]; $x.__enum__ = gscript.Token; return $x; };
